...
export const applyDevDefaults = (feed) => {
    ...
    feed.f2_image.Url =
        "2025/attract/970x250_engineers_attract_development_image_f2.jpeg";
    ...
    feed.f3_image.Url =
        "2025/attract/970x250_engineers_attract_development_image_f3.jpeg";
    ...
    feed.f4_image.Url =
        "2025/attract/970x250_engineers_attract_development_image_f4.jpeg";
