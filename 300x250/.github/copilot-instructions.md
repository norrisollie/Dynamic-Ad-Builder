...
- Use `src/scripts/environments/template-notes-300x250.md` as the source of truth for 300x250 template keys, frame usage, and feed column patterns.
...
- `src/scripts/environments/template-notes-300x250.md`
- `src/scripts/environments/applyDevDefaults.js`
