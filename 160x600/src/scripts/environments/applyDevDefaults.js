...
export const applyDevDefaults = (feed) => {
    ...
    feed.reporting_label =
        "160x600_Royal_Navy_Attract_Engineers_Professional_Benefits_Development";
    feed.default = true;
    feed.active = true;
    feed.hero = true;
    ...
    feed.f2_image.Url =
        "2025/attract/160x600_engineers_attract_development_image_f2.jpeg";
    ...
    feed.f3_image.Url =
        "2025/attract/160x600_engineers_attract_development_image_f3.jpeg";
    ...
    feed.f4_image.Url =
        "2025/attract/160x600_engineers_attract_development_image_f4.jpeg";
