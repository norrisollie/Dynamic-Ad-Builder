...
export const applyDevDefaults = (feed) => {
    ...
    feed._id = 0;
    feed.preview = "";
    // Use an Attract Engineers row for preview
    feed.id = 120;
    feed.uid = 120;
    feed.reporting_label =
        "320x50_Royal_Navy_Attract_Engineers_Professional_Benefits_Development";
    feed.default = true;
    feed.active = true;
    feed.hero = true;
    ...
    feed.exit_url = {};
    feed.exit_url.Url = "https://www.example.com";
    ...
    // Global CTA is empty for Attract; each hero frame defines its own CTA
    feed.global_cta = "";

    // Frame 1 copy/image from feed row
    ...
    feed.f2_image.Url =
        "2025/attract/320x50_engineers_attract_development_image_f2.jpeg";
    ...
    feed.f3_image.Url =
        "2025/attract/320x50_engineers_attract_development_image_f3.jpeg";
    ...
    feed.f4_image.Url =
        "2025/attract/320x50_engineers_attract_development_image_f4.jpeg";
