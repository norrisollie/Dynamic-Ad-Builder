...
- Use `src/scripts/environments/template-notes-320x50.md` as the source of truth for 320x50 template keys, frame usage, and feed column patterns.
...
- `src/scripts/environments/template-notes-320x50.md`
