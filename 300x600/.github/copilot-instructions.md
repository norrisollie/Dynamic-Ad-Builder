...
- Use `src/scripts/environments/template-notes-300x600.md` as the source of truth for 300x600 template keys, frame usage, and feed column patterns.
...
- `src/scripts/environments/template-notes-300x600.md`
