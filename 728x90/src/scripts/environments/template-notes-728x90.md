# 728x90 Template & Feed Notes

This file documents the template keys that 728x90 can use and how the feed rows should be structured, using the existing ad feed as the reference.
...
The 728x90 size follows the same feed patterns as the other sizes in the reference sheet (300x250, 160x600, 300x600, 320x250, 320x50, 970x250). Only the asset paths change to use `728x90_…`.

### Shared columns

- `creative_dimensions` – e.g. `728x90`.
...
- Frame usage
    ...
    - `f2_image.Url`, `f3_image.Url`, `f4_image.Url` – size-specific image paths (e.g. `2025/attract/728x90_ratings_attract_travel_image_f2.jpeg`).
    - `f2_cta`, `f3_cta`, `f4_cta` – always `Apply now` in the sheet.

    #### Sticky reference: Attract Engineers – Professional Benefits / Development
    - `reporting_label` – `728x90_Royal_Navy_Attract_Engineers_Professional_Benefits_Development`.
    ...
    - Frame 2 copy – `FUTURE SHAPER` + CTA `Apply now` + image `2025/attract/728x90_engineers_attract_development_image_f2.jpeg`.
    - Frame 3 copy – `EDGE GAINER` + CTA `Apply now` + image `2025/attract/728x90_engineers_attract_development_image_f3.jpeg`.
    - Frame 4 copy – `BECOME A SPECIALIST` + CTA `Apply now` + image `2025/attract/728x90_engineers_attract_development_image_f4.jpeg`.
...
- Frame usage
    ...
    - `f1_image.Url` – the hero image for the size, e.g. `2025/convert/728x90_ratings_convert_pay_image.jpeg`.
    - `f1_cta` – `Apply now`.
