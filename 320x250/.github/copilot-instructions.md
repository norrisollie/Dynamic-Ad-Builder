...
- Use `src/scripts/environments/template-notes-320x250.md` as the source of truth for 320x250 template keys, frame usage, and feed column patterns.
...
- `src/scripts/environments/template-notes-320x250.md`
