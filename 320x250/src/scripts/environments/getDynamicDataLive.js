 ...
 */
export const getDynamicDataLive = () => {
    // Config object for live environment, to set profile ID and feed name accordingly

    const FEED_NAME = "LIVE__Royal_Navy__Dynamic_Feed_Feed";

    // set profile ID for Enabler (live)
    Enabler.setProfileId(10952232);

    // Create dynamic content object, will be populated from live data below
    ...
    // set default values for the live feed
